...
// import { getValue, padding } from '@mui/system';
...
function JobNew() {
  ...
  const onSubmit = async () => {
    ...
    const confirmationButton = window.confirm(
      ...
      "Job have been Ctreated Successfully..."
    );
    if (confirmationButton === true) {
      const result = AxiosApi.post(`/candidate_job/`, jsonPost,)
...
// function CandidateNew() {
// const [jid, setJId] = useState('');
// const [title, setTitle] = useState('');
// const [descrip, setDescrip] = useState('');
// const [recruiter, setRecruiter] = useState('');
// const [dispweb, setDispweb] = useState(false);
