...
const AddNewCandidate = props => {
  ...
  //   setFiles(e.target.files[0])
  //   const formData = new FormData();
  //   formData.append('pan_file', e.target.files[0]);
  // }
  ...
  //   setFiles(e.target.files[0])
  //   const formData = new FormData();
  //   formData.append('aadhar_file', e.target.files[0]);
  // }
  ...
  const onSubmit = async () => {
    ...
    const confirmationButton = window.confirm(
      ...
      "Candidate have been Ctreated Successfully..."
    );
    if (confirmationButton === true) {
      // fetch('http://localhost:3000/Data/', {
      //   method: 'POST',
     ...
     const result= AxiosApi.post(
        ...
        .then(function (result) {
          ...
          if (result.data == "Success") {
            alert(
              "Candidate have been Successfully "
            );
          }
                    ...
                    <div className="card-body registrationCard">
                      <div className="form-group row">
                        ...
                        <input type="file"
                          ...
                          id="cv" onChange={filestore} name="cv" multiple />
                        <small className="invalid-feedback">
                          {errors.cv?.message}
                        </small>
                        {/* <input
