...
const ViewCandidate = () => {
  ...
  const [getValues, setGetValues] = useState({
    email: allGetData.email,
    phone: allGetData.phone,
    role: "missing",
    experience_years: allGetData.experience_years,
    experience_months: allGetData.experience_months,
    industry_id: allGetData.industry_id,
    cv: allGetData.cv,
    cover_letter: "demo",
    job_id: allGetData.job_id,
    remarks: allGetData.remarks,
    status: allGetData.status,
    current_ctc: allGetData.current_ctc,
    expected_ctc: allGetData.expected_ctc,
    notice_period: allGetData.notice_period,
    open_to_relocate: allGetData.open_to_relocate,
    city_id: allGetData.city_id,
    country_id: allGetData.country_id,
    country_calling_code_id: allGetData.country_calling_code_id,
    current_ctc_currency_id: allGetData.current_ctc_currency_id,
    expected_ctc_currency_id: allGetData.expected_ctc_currency_id,
    first_name: allGetData.first_name,
    last_name: allGetData.last_name,
    other_industry: allGetData.other_industry,
    salutation: allGetData.salutation,
    state_id: allGetData.state_id,
    submitted_datetime: allGetData.submitted_datetime,
    job_change_reason_id: allGetData.job_change_reason_id,
    cv_displayname: "don't know",
    exported: allGetData.exported,
    mail_response: allGetData.mail_response,
    mail_send: allGetData.mail_send,
    transaction_error: "don't know",
    middle_name: allGetData.middle_name,
    father_name: allGetData.father_name,
    gender: allGetData.gender,
    permanent_address: allGetData.permanent_address,
    communication: allGetData.communication,
    emergency_contact: allGetData.emergency_contact,
    emergency_contact_name: allGetData.emergency_contact_name,
    emergency_contact_relationship: allGetData.emergency_contact_relationship,
    blood_group: allGetData.blood_group,
    uan_number: allGetData.uan_number,
    passport: allGetData.passport,
    passport_validity: allGetData.passport_validity,
    adhaar_number: allGetData.adhaar_number,
    pan_number: allGetData.pan_number,
    education: allGetData.education,
    bank_name: allGetData.bank_name,
    branch: allGetData.branch,
    account_name: allGetData.account_name,
    account_number: allGetData.account_number,
    ifsc_code: allGetData.ifsc_code,
    old_bank_name: allGetData.old_bank_name,
    old_bank_branch: allGetData.old_bank_branch,
    old_account_name: allGetData.old_account_name,
    old_account_number: allGetData.old_account_number,
    old_ifsc_code: allGetData.old_ifsc_code,
    prf_department: allGetData.prf_department,
    prf_joining_date: allGetData.prf_joining_date,
    prf_group_health_insurance: allGetData.prf_group_health_insurance,
    prf_acenet_asset: allGetData.prf_acenet_asset,
    prf_client_asset: allGetData.prf_client_asset,
    prf_form_16: allGetData.prf_form_16,
    prf_covid_certificate: allGetData.prf_covid_certificate,
    prf_bgv_certificate: allGetData.prf_bgv_certificate,
    prf_inititation_date: allGetData.prf_inititation_date,
    prf_report_date: allGetData.prf_report_date,
    prf_client_name: allGetData.prf_client_name,
    prf_agency: allGetData.prf_agency,
    prf_submission_date: allGetData.prf_submission_date,
    type: allGetData.type,
    date_of_birth: allGetData.date_of_birth,
    location: allGetData.location,
    medical_history: allGetData.medical_history,
    linkedin: allGetData.linkedin,
    documents_path: allGetData.documents_path,
    documents_type: allGetData.documents_type,
    designation: allGetData.designation,
    source: allGetData.source,
    // prf_exit_date: "2022-11-08T07:42:30.767Z",
    prf_exit_date: allGetData.prf_exit_date,
    description: "don't know",
    category: "missing",
    joining_salary: allGetData.joining_salary,
    legal_history: "missing",
    esi_ip_number: allGetData.esi_ip_number,
    aadhar_file: allGetData.aadhar_file,
    pan_file: allGetData.pan_file,
    passport_file: allGetData.passport_file,
  })
  ...
  // console.log(time);
  useEffect(() => {
    // fetch('https://e5c1-106-215-94-122.ngrok.io/globalnetwork_candidate/' + id)
    fetch('http://localhost:3000/Data/' + id)
      .then((resp) => resp.json())
      .then((result) =>
        setGetValues(result)
    ...
    //     //alert("hello");
    //     const result = AxiosApi.get(
    //       `https://1b57-122-161-66-123.ngrok.io/globalnetwork_candidate/1710`

    //     ).then((resp)=> resp.json()).then((result)=>console.log(result))
    //     setAllGetData(result)
    //   }
    // ApiPostfetchData()
  }, []);
  ...
  const onSubmit = (e) => {
    e.preventDefault()
    const jsonPost = {
      email: getValues.email === undefined ? allGetData.email : getValues.email,
    ...
    if (confirmationButton === true) {
      async function ApiPostfetchData() {
        ...
        //     alert(
        //       "You have been Successfully Registered to our Portal. Your Registration Number, Login Id and Password sent to your Registered Email."
        //     );
        //     //history.push("/");
        //   }
        //   // history.push('/')
        //   else {
        //     //alert("You are Registerd Not Successfully");
        //     alert(result.data);
        //   }
        // });
      }
